...
import { validateRegister } from '@src/modules/authentication/validations/validateUser.js'
...
router.post('/register', validateRegister, (req, res) => registerUserController.handle(req, res))
